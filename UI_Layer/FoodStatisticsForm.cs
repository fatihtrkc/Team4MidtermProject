...
namespace UI_Layer
{
    public partial class FoodStatisticsForm : Form
    {
        ...
        //    var list = dbbl.AddedFoodBL.GetAllByUserId(userId);
        //    foreach (var item in list)
        //    {
        //        ListViewItem lvi = new ListViewItem();

        //        lvi.Text = item.FoodId.ToString();
        //        lvi.SubItems.Add(dbbl.AddedFoodBL.GetCountFoodTop(userId, item.FoodId).ToString());
